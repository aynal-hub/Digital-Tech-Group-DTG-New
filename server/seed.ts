...
async function seed() {
  ...
  await db.insert(teamMembers).values([
    { name: "MD Aynal Hossain", designation: "Founder & Managing Director", bio: "Visionary leader with extensive experience in recruitment, sourcing, and digital marketing. MD Aynal Hossain founded Digital Tech Group with a mission to deliver world-class business solutions globally.", isFounder: true, orderIndex: 1, isActive: true },
